...
<html>
    ...
    <body>
    <?php
        echo "<form name=\"form\" action=\"administradores_cambios.php?id=' + $id\" method=\"POST\" novalidate>";
    ?>
            <div>
                <table>
                    <tr>
                        <td class="title">EDICIÓN DE ADMINISTRADORES</td> 
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="bottom">
                            <input class="button" id="lightGray" type="submit" value="Guardar" onclick="return validarFormulario();">
                            <input class="button" id="lightGray" type="reset" value="Regresar al Listado" onclick="window.history.back(); return false;">
