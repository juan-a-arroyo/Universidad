...
<html>
    ...
    <body>
        <form name="form" action="administradores_salva.php" method="POST" enctype="multipart/form-data">
            <div>
                <table>
                    <tr>
                    ...
                    <tr>
                        <td class="first">Correo electrónico:<br>
                            <input type="email" name="correo" id="correo" placeholder="usuario@mail.com" onblur="validarCorreo()">
