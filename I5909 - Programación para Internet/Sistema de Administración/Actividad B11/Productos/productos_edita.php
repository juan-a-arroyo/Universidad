...
<html>
    ...
    ?>
            <div>
                <table>
                    <tr>
                        <td class="title" colspan="2">EDICIÓN DE PRODUCTOS</td> 
                    </tr>
                                ...
                                <div class="image-container">
                                    <?php
                                        if(!is_file("archivos/fotos/$archivo"))
                                            echo "<img class=\"preview\" id=\"preview-image\" src=\"../css/icons/default.png\" alt=\"Producto\">";
                                        else
                                            echo "<img class=\"preview\" id=\"preview-image\" src=\"$url_imagen\" alt=\"Producto\">";
                                    ?>
                                </div>
                            </label>
