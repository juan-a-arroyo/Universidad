<?php
    ...
    $ruta_administradores = "empleados_lista.php";
...
<html>
    ...
    <body>
    <?php
        echo "<form name=\"form\" action=\"empleados_sobreescribe.php?id=' + $id\" method=\"POST\" enctype=\"multipart/form-data\">";
    ?>
            <div>
                <table>
                    <tr>
                        <td class="title" colspan="2">EDICIÓN DE EMPLEADOS</td> 
                    </tr>
                                ...
                                <div class="image-container">
                                    <?php
                                        if(!is_file("archivos/fotos/$archivo"))
                                            echo "<img class=\"preview\" id=\"preview-image\" src=\"../css/icons/default.png\" alt=\"Empleado\">";
                                        else
                                            echo "<img class=\"preview\" id=\"preview-image\" src=\"$url_imagen\" alt=\"Empleado\">";
                                    ?>
                                </div>
                            </label>
                    ...
                    <tr>
                        <td class="first">Apellidos:<br>
                            <?php
                                echo "<input id=\"apellidos\" type=\"text\" name=\"apellidos\" placeholder=\"Apellidos\" value=\"$apellido\">"
                            ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="first">Correo electrónico:<br>
                            <?php
                                echo "<input id=\"correo\" type=\"email\" name=\"correo\" placeholder=\"usuario@mail.com\" value=\"$correo\" onblur=\"validarCorreo()\">"
                            ?>
                    ...
                    <tr>
                        <td class="first">Contraseña:<br>
                            <input id="pass" type="password" name="pass" placeholder="Contraseña (Sin cambios)">
                        </td>
                    </tr>
                    <tr >
                        <td class="first">Rol:
