...
<html>
    ...
    <script>
        ...
        function editar(id){
            window.location.href = 'promociones_edita.php?id=' + id;
        }
    </script>
    <body>
        <div>
            <table>
                <tr>
                    <td class="title" colspan="8">LISTADO DE PROMOCIONES</td>
                </tr>
                <?php include('../Funciones/menu.php'); ?>
                <tr>
                    <td class="first" class="header">ID</td>
                    <td class="header" colspan="3">Nombre</td>
                    <td class="new"><a href="promociones_alta.php"><img src="../css/icons/add.png" alt="Nuevo registro" width="35"></a><br></td>
                </tr>
                    <?php
