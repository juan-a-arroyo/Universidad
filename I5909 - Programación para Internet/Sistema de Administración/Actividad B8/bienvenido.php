<?php
    ...
    if($idU == "" || $nombre == "" || $correo == "")
        header("Location: Empleado/Funciones/salir.php");
?>
<!doctype html>
<html>
    <head>
    ...
    <link href="Empleado/css/style.css" type="text/css" rel="stylesheet">
    <script src="js/jquery-3.3.1.min.js"></script>
    <script>
        function administradores(){
            window.location.href = 'Empleado/empleados_lista.php';
        }
        function cerrarSesion(){
            window.location.href = 'Empleado/Funciones/salir.php';
        }
    </script>
    <body>
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td class="tab">
                        <input class="button" type="button" value="Empleados" onclick="administradores();">
                    </td>
                    <td class="tab">
                        <input class="button" type="button" value="Productos" onclick="">
                    </td>
                    <td class="tab">
                        <input class="button" type="button" value="Promciones" onclick="">
                    </td>
                    <td class="tab">
