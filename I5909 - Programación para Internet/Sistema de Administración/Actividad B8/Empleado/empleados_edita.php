...
<html>
    ...
    <body>
    <?php
        echo "<form name=\"form\" action=\"empleados_cambios.php?id=' + $id\" method=\"POST\" enctype=\"multipart/form-data\" novalidate>";
    ?>
            <div>
                <table>
                    <tr>
                        ...
                        <td id="photo" class="first" width="500" rowspan="5">
                            <label for="archivo">
                                <div class="image-container">
                                    <?php
                                        echo "<img class=\"preview\" id=\"preview-image\" src=\"archivos/fotos/$archivo\" alt=\"Empleado\">";
                                    ?>
                                </div>
                            </label>
