                ...
                <table>
                        ...
                        <td id="photo" class="first" width="500" rowspan="5">
                            <label for="archivo">
                                <div class="image-container">
                                    <img class="product-image" id="preview-image" src="../../css/icons/light_default.png" alt="Producto">
                                </div>
                            </label>
                    ...
                    <tr>
                        <td class="first">Código:<br>
                            <input type="text" id="codigo" name="codigo" placeholder="Código" onblur="validarCodigo()">
                    ...
                    <tr>
                        <td class="first">Costo:<br>
                            <input id="costo" type="text" name="costo" placeholder="Costo">
                        </td>
                    </tr>
                    <tr>
