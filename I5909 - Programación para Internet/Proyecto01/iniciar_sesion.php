<?php
    session_start();
    if(isset($_SESSION['id_usuario']) && isset($_SESSION['nombre_usuario']) && isset($_SESSION['correo_usuario']))
...
<html>
    ...
    <script>
        function autentificar() {
            ...
            if(user != "" && pass != ""){
                $.ajax({
                    url: 'Funciones/valida_usuario.php?user='+user+'&pass='+pass,
                    method: 'POST',
            ...
            <table>
                ...
                <tr>
                    <td class="first">Usuario:
                        <input type="text" name="usuario" id="usuario" placeholder="usuario@mail.com" required>
                    </td>
                </tr>
                <tr>
